...
const FeaturedProducts = () => {
  const phoneNumber = "2347048603741";
      ...
      <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
        {featuredProducts.slice(0, 4).map((product) => {
          const whatsappUrl = `https://wa.me/${phoneNumber}?text=${encodeURIComponent(
            `Hi, I would like to order ${product.name} (₦${product.price.toLocaleString()}).`
          )}`;
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <div className="mt-auto pt-4 flex items-center justify-between gap-2">
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 text-xs font-medium text-[#C9A227] hover:text-white hover:bg-[#C9A227] border border-[#C9A227] px-3 py-2 rounded-xl transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#C9A227] focus-visible:ring-offset-2"
                  >
