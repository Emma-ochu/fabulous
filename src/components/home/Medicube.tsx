...
const Medicube = ({ onSelectProduct }: MedicubeProps) => {
  return (
    <>
      ...
      <section id='medicube' className='relative overflow-hidden bg-[#FAF8F4]'>
          ...
          <div className='flex flex-col justify-center order-2 lg:order-1'>
            ...
            <ul className='mt-6 sm:mt-8 space-y-3 sm:space-y-4' role='list'>
              {medicubeBenefit.map((benefit) => (
                <li
                  key={benefit}
                  className='flex items-center gap-3 p-2 -ml-2 rounded-lg hover:bg-[#C9A227]/5 transition-colors'
                >
                  <svg
      ...
      <section className='max-w-[1400px] mx-auto px-6 md:px-16 py-20'>
        <div className='text-center mb-12'>
          ...
          <p className='mt-4 max-w-2xl mx-auto text-gray-600'>
            Discover how Medicube Night Wrapping Mask transforms your nighttime
            skincare routine with visible results.
          </p>
        </div>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-10 items-stretch'>
          ...
          <article className='group bg-white rounded-3xl shadow-lg border border-gray-100 overflow-hidden flex flex-col h-full hover:shadow-xl hover:-translate-y-1 transition-all duration-300'>
            ...
            <div className='p-6 flex flex-col flex-grow'>
              ...
              <p className='mt-3 text-gray-600'>
                Wake up to smoother, brighter and healthier-looking skin with
          ...
          <article className='group bg-white rounded-3xl shadow-lg border border-gray-100 overflow-hidden flex flex-col h-full hover:shadow-xl hover:-translate-y-1 transition-all duration-300'>
            ...
            <div className='p-6 border-t border-gray-50 flex flex-col flex-grow'>
              ...
              <p className='mt-3 text-gray-600'>
                Apply a thin layer before bed, leave it overnight, and rinse
